...
@section('content')
    ...
    <div class="max-w-6xl mx-auto grid md:grid-cols-2 grid-cols-1 sm:py-8 gap-10 ">
        {{-- left side --}}
        <div class="w-full">
            <img src="{{ asset('storage/files/photos/'.$posts[0]->img) }}" alt="sawit.info" class="w-full object-center h-80 object-cover sm:px-4 px-0 shadow-sm">
                ...
                @foreach($posts as $key => $data)
                    ...
                    <div class="py-2">
                        ...
                        <div class="flex  w-full justify-between mt-1 space-x-6  ">
                            <img src="{{ asset('storage/files/photos/thumbnail/'.$data->img) }}" alt="sawit.info" class="md:w-5/12 w-6/12 sm:h-28 h-24 object-cover shadow-sm">
